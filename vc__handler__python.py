...
__vc_spec = util.spec_from_file_location("music_api_project.wsgi", "./music_api_project/wsgi.py")
__vc_module = util.module_from_spec(__vc_spec)
sys.modules["music_api_project.wsgi"] = __vc_module
...
if 'handler' in __vc_variables or 'Handler' in __vc_variables:
    ...
    print('Missing variable `handler` or `app` in file "music_api_project/wsgi.py".')
    print('See the docs https://vercel.com/docs/runtimes#advanced-usage/advanced-python-usage')
    exit(1)
